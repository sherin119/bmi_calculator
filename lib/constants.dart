...
const kHeightTextStyle = TextStyle(fontSize: 50, fontWeight: FontWeight.w900);
...
const kResultTextStyle = TextStyle(color: Color(0xFF24D876),
...
const kActiveCardColor = Color(0xFF1D1E30);
const kInactiveCardColor = Color(0xFF111340);
